...
import { videoCampaignUpdateBuktiPembayaran } from "@/server/home/video-campaign/detail-pendaftaran/update/update-bukti-pembayaran";
...
export const VideoCampaignUpdateImageDialog = ({ team }: Props) => {
   ...
   const handleUpdate = async () => {
      ...
      startTransition(async () => {
         ...
         const res = await videoCampaignUpdateBuktiPembayaran({
            file: file,
