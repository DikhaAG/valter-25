...
import { IndividuUpdateImageDialog } from "@/components/home/seminar/registration-detail/individu-update-image-dialog";
               ...
               <>
                  <div className="p-6 flex flex-col gap-y-8 md:gap-y-6">
                     ...
                     <div className="">
                        <div className="space-y-2">
                           <Label>
                              Domisili{wrapSymbols("(")}Kota{wrapSymbols("/")}
                              Kabupaten{wrapSymbols(")")}
                           </Label>
