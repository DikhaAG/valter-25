...
export function FormRegistrasi() {
        ...
        const form = useForm<FormPendaftaranTimEsportSchemaType>({
                resolver: zodResolver(formPendaftaranTimEsportSchema),
                defaultValues: {
                        namaTim: "",
                        instansi: "",
                        noWa: "",
        ...
        async function onSubmit(data: FormPendaftaranTimEsportSchemaType) {
                setLoading(true);
