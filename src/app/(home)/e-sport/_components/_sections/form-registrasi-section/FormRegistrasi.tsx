...
import { UploadBuktiPembayaranField } from "@/app/(home)/e-sport/_components/_sections/form-registrasi-section/UploadBuktiPembayaranField";
...
export function FormRegistrasi() {
        ...
        async function onSubmit(data: RegistrasiFormSchema) {
                ...
                const cekPemain = await cekKetersediaanPemain(data.tim);
