...
import { WebDesignRegistrationCheckButton } from "./registration-check-button";
import { WebDesignMahasiswaForm } from "./mahasiswa/main";
import { WebDesignUmumForm } from "./umum/main";
import {
   Tabs,
   TabsContent,
   TabsList,
...
export function WebDesignForm({ isVisible }: Props) {
   return (
      <section
      ...
      >
         <div className="max-w-md md:max-w-2xl mx-auto">
            ...
            <WebDesignRegistrationCheckButton />
         </div>
      </section>
   );
}
