...
import { WebDesignTimMahasiswaFormSchemaType } from "@/zod/home/web-design/mahasiswa-form";
import { WebDesignTimUmumFormSchemaType } from "@/zod/home/web-design/umum-form";

interface Props {
   form:
      | UseFormReturn<WebDesignTimUmumFormSchemaType>
      | UseFormReturn<WebDesignTimMahasiswaFormSchemaType>;
}
