...
/**
 * Skema validasi untuk setiap peserta lomba video campaign dalam sebuah tim.
 * @description
 ...
 * - `peserta`: Sebuah array yang harus berisi skema validasi `formPendaftaranSchema` untuk setiap pemain.
 */
