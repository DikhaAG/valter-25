...
export const videoCampaignPesertaMahasiswaFormSchema = z.object({
   id: z.uuid().optional(),
...
export const videoCampaignTimMahasiswaFormSchema = z
   .object({
      as: asEnumSchema,
      ...
      peserta: z.array(videoCampaignPesertaMahasiswaFormSchema),
   })
   .refine(
      async (data) => {
...
export type VideoCampaignTimMahasiswaFormSchemaType = z.infer<
   typeof videoCampaignTimMahasiswaFormSchema
>;

export type VideoCampaignPesertaMahasiswaFormSchemaType = z.infer<
   typeof videoCampaignPesertaMahasiswaFormSchema
>;
