import { z } from "zod";
import { pesertaVideoCampaignTableSchema } from "./peserta";
 ...
 */
export const timVideoCampaignTableSchema = z.object({
   /**
    * ID unik tim.
    ...
    */
   pesertaWebDesign: z.array(pesertaVideoCampaignTableSchema),
   as: enumSchema
});
 ...
 */
export type TimVideoCampaignTableSchema = z.infer<
   typeof timVideoCampaignTableSchema
>;
