...
import type { WebDesignRegistrationDisplaySchemaType } from "@/zod/home/web-design/detail-pendaftaran/display";

/**
 * Mengonversi data JSON ke format Excel dan memicu pengunduhan.
 * @param {object} data - Objek data tim.
 */
export const webDesignExportRegistrationDataMahaisiswaToExcel = (
   data: WebDesignRegistrationDisplaySchemaType
) => {
