 ...
 */
export const videoCampaignExportRegistrationDataMahasiswaToExcel = (
   data: VideoCampaignRegistrationDisplaySchemaType
) => {
   ...
   saveAs(blob, `data_pendaftaran_video_campaign_valter_${data.namaTim}.xlsx`);
};
