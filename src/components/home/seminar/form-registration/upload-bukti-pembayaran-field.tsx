...
interface Props {
   form:
      | UseFormReturn<ParticipantAsGeneral>
      | UseFormReturn<ParticipantAsMahasiswa>
      | UseFormReturn<ClassRegstrationSchema>;
}
...
export function UploadBuktiPembayaranField({ form }: Props) {
   ...
   const onDrop = useCallback(
      (acceptedFiles: File[]) => {
         ...
         (
            form as UseFormReturn<ParticipantAsGeneral | ParticipantAsMahasiswa>
