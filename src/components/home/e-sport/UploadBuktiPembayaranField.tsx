...
export function UploadBuktiPembayaranField({ field, form }: Props) {
        ...
        return (
                <div className="flex flex-col gap-2">
                        <div
                                {...getRootProps()}
                                className="transition-all duration-100 ease-in -translate-x-1 -translate-y-1 hover:translate-0 border-4 border-dashed border-foreground/70 shadow-[8px_8px_0px_#00000040] rounded-md p-4 cursor-pointer hover:bg-[#00000040]/10"
                        >
                                <input {...getInputProps()} />
