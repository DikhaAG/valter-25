...
import {
   getTotalPendaftaranKelasPelatihan,
   getTotalPesertaPelatihanIndividu,
} from "@/server/services/admin/getTotalPeserta";
import { useEffect, useState } from "react";
import { PelatihanPendaftaranKelasDataTable } from "./data-table/pendaftaran-kelas/data-table";
import { PesertaIndividuDataTable } from "./data-table/peserta-individu/data-table";

export function PelatihanTabsTable() {
   ...
   useEffect(() => {
      getTotalPendaftaranKelasPelatihan().then((res) =>
         res.success
            ? setTotalPendaftaranKelas(res.data!)
            : setTotalPendaftaranKelas(0)
      );
      getTotalPesertaPelatihanIndividu().then((res) =>
   ...
   return (
      ...
      >
         ...
         >
            <PelatihanPendaftaranKelasDataTable />
         </TabsContent>
         <TabsContent
            value="peserta"
            className="relative flex flex-col gap-4 overflow-auto px-4 lg:px-6"
