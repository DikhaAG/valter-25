...
import { pesertaIndividuPelatihanColumns } from "./columns";
import { Skeleton } from "@/components/ui/skeleton";
import { getPesertaIndividuPelatihan } from "@/server/actions/queries/pelatihan";
...
export function PesertaIndividuDataTable() {
   ...
   const table = useReactTable({
      ...
      columns: pesertaIndividuPelatihanColumns,
      state: {
         sorting,
         columnVisibility,
         rowSelection,
   ...
   React.useEffect(() => {
      getPesertaIndividuPelatihan({revPath: "/admin/pelatihan"}).then((res) => {
         if (res.success) {
               ...
               <Table>
                  ...
                  <TableBody className="**:data-[slot=table-cell]:first:w-8">
                     {table.getRowModel().rows?.length ? (
                        ...
                        <TableRow>
                           <TableCell
                              colSpan={pesertaIndividuPelatihanColumns.length}
