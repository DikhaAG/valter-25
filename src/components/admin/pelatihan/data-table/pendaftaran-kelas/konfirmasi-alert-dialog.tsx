...
import { konfirmasiPendaftaranKelasPelatihan } from "@/server/services/admin/konfirmasi-pendaftaran";
import { Check } from "lucide-react";

interface Props {
  idKelas: string;
}
export function KonfirmasiPendaftaranKelasAlertDialog({ idKelas, }: Props) {
  async function handleKonfirmasi() {
    const res = await konfirmasiPendaftaranKelasPelatihan(idKelas)
    if (!res.success) {
