...
import { pendaftaranKelasPelatihanColumns } from "./columns";
import { ClassRegistrationTable } from "@/models/pelatihan/table";
import { Input } from "@/components/ui/input";
import { getAllClassRegistration } from "@/server/actions/queries/pelatihan";
...
export function PelatihanPendaftaranKelasDataTable() {
   ...
   const table = useReactTable({
      ...
      columns: pendaftaranKelasPelatihanColumns,
      state: {
         sorting,
         columnVisibility,
         rowSelection,
   ...
   React.useEffect(() => {
      getAllClassRegistration({ revPath: "/admin/pelatihan" }).then((res) =>
      ...
      <>
         ...
         <div className="flex items-center py-4">
            <Input
               ...
               value={
                  (table.getColumn("kelas")?.getFilterValue() as string) ?? ""
               }
               onChange={(event) =>
               ...
               <Table>
                  ...
                  <TableBody className="**:data-[slot=table-cell]:first:w-8">
                     {table.getRowModel().rows?.length ? (
                        ...
                        <TableRow>
                           <TableCell
                              colSpan={pendaftaranKelasPelatihanColumns.length}
