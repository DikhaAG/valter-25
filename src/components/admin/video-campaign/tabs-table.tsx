...
import {
   getTotalTimVideoCampaign
} from "@/server/services/admin/getTotalPeserta";
import { useEffect, useState } from "react";
import { VideoCampaignTimDataTable } from "./data-table";

export function VideoCampaignTabsTable() {
   const [totalTim, setTotalTim] = useState<number | undefined>();
   useEffect(() => {
      getTotalTimVideoCampaign().then((res) =>
         res.success
