...
import { pendaftaranKelasSeminarColumns } from "./columns";
...
export function SeminarPendaftaranKelasDataTable() {
   ...
   const table = useReactTable({
      ...
      columns: pendaftaranKelasSeminarColumns,
      state: {
         sorting,
         columnVisibility,
         rowSelection,
               ...
               <Table>
                  ...
                  <TableBody className="**:data-[slot=table-cell]:first:w-8">
                     {table.getRowModel().rows?.length ? (
                        ...
                        <TableRow>
                           <TableCell
                              colSpan={pendaftaranKelasSeminarColumns.length}
