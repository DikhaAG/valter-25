...
import { exportSemuaDataPesertaSeminar } from '@/server/services/admin/ekspor-data';
import { IconDownload } from '@tabler/icons-react';
import { useState } from 'react';

export function ExportSemuaDataPesertaSeminarButton() {
  const [isExporting, setIsExporting] = useState(false);

  const handleExport = async () => {
    setIsExporting(true);
    const result = await exportSemuaDataPesertaSeminar();
