...
import { konfirmasiTimWebDesign } from "@/server/services/admin/konfirmasi-pendaftaran";
...
export function KonfirmasiTimDialog({ id, }: Props) {
  async function handleKonfirmasi() {
    const res = await konfirmasiTimWebDesign(id)
    if (!res.success) {
    ...
    window.location.href = "/admin/web-design"
  }
  return (
    <AlertDialog>
